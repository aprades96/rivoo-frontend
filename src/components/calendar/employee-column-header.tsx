 ...
 * "Colores de empleado en la agenda") justamente para esto. Se indexan por
 * POSICION de columna, no por id: asi dos empleados contiguos nunca comparten
 * color y el reparto es estable mientras no cambie el orden de la lista.
 *
    ...
    >
      <div
        ...
        className={cn(
          ...
          employee &&
            !colorHex &&
            FALLBACK_AVATAR_CLASSNAMES[index % FALLBACK_AVATAR_CLASSNAMES.length]
        )}
      ...
      <div className="flex min-w-0 flex-col">
        ...
        <span className="truncate text-[11px] text-muted-foreground-2">
